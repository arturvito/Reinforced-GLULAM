function plot_sensitivities_3d_reinforcement_full(ELIST,NLIST,beso,Variable,x,y,z)
x=x;
y=y;
z=-z;
...
NLIST_simp_sym = NLIST_simp;
NLIST_simp_sym(:,3) = - NLIST_simp_sym(:,3);
...
patch('Faces',ELIST_simp(find(plot_aux_densities),[1:4]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[5:8]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[1,2,6,5]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[3,4,8,7]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[1,4,8,5]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[2,3,7,6]),'Vertices',NLIST_simp_sym(:,[1,3,2]),'FaceVertexCData',sign(Variable(find(plot_aux_densities))).*(abs(Variable(find(plot_aux_densities)).^pot)),'FaceColor','flat','Linestyle','none')
